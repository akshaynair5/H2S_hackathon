...
import hashlib
from reasoning_generator import get_explanation_for_fake
...
def detect_text():
    ...
    # If the claim is likely fake, generate reasoning
    if str(output.get("label", "")).lower() in ["fake", "misinformation", "false"]:
        reasoning = get_explanation_for_fake(text)
